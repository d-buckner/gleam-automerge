...
-define(FILEPATH, "src/automerge.gleam").
...
-file("src/automerge.gleam", 16).
-spec new_doc() -> doc_ref().
new_doc() ->
    'Elixir.AutomergeNif':doc_new().

-file("src/automerge.gleam", 21).
